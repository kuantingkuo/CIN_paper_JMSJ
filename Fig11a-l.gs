...
while(it<=tnum)
    ...
    while(i<=2)
        ...
        if(i=1)
            ...
            lab=substr(letters,labnum_top,1)
            labstr='('lab')'
            'set string 1'
            'set strsiz 0.14 0.18'
            'draw string 'xpos' 'ypos' 'labstr
            labnum_top=labnum_top+1
        endif
        'off'
        i=i+1
    endwhile
    ...
    while(i<=2)
        ...
        if(i=1)
            ...
            xpos=xmin+0.02*(xmax-xmin)
            ypos=ymax-0.15*(ymax-ymin)
            lab=substr(letters,labnum_bot,1)
            labstr='('lab')'
            'set string 1'
            'set strsiz 0.14 0.18'
            'draw string 'xpos' 'ypos' 'labstr
            labnum_bot=labnum_bot+1
        endif
        'off'
        i=i+1
    endwhile
    it=it+1
endwhile
'gxprint Fig11a-l.png white'
'gxprint Fig11a-l.svg white'
